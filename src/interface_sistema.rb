...
def show_login_menu
  loop do
    ...
    if login(username, password)
      ...
      show_gestão_estoque_menu
      break
    else
      puts "\nLogin falhou. Verifique seus dados e tente novamente."
    end
  end
end

def show_gestão_estoque_menu
  loop do
    puts "\n"
